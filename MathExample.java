...
public final class MathExample {
  ...
  public static final @Unsigned double E = 2.7182818284590452354;
  public static final @Unsigned double PI = 3.14159265358979323846;

  private static final @Signed double PI_OVER_180 = PI / 180.0;
  private static final @Signed double PI_UNDER_180 = 180.0 / PI;
  static @Unsigned int b=-60,c=0;

  public static @Signed double abs(@Signed double x) {
    ...
    // See http://www.concentric.net/~Ttwang/tech/javafloat.htm for details.
	  c = b >>> 1;        //because >>> operator works only with @unsigned,mentioned in manual
	  return x <= 0 ? 0.0 - x : x;   //because <= works only with @signed,mentioned in manual
  }

  public static @Signed float abs(float x) {
  ...
  public static @Signed double toDegrees(@Signed double x) {
